...
define("APPURL", "http://localhost:3000/bookstore");
            ...
            <button class="btn btn-outline-success" type="submit">Search</button>
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <?php if (isset($_SESSION['username'])) : ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link active  text-white" aria-current="page" href="http://localhost:3000/shopping/cart.php"><i class="fas fa-shopping-cart"></i>(<?php echo $getNumber->num_products; ?>)</a>
                        </li>
